    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                   ${hospitalname}-${departmentname}-${doctorname}- 预约管理
                </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="${ctx}/admin/appointments/doctorindex?pcode=2&subcode=1&hospitalid=${hospitalid}&hospitalname=${hospitalname}"
