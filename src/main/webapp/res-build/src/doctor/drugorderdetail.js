define(function (require, exports, module) {
    ...
    var Utilitiy = {
        ...
        bind: function () {
            ...
            pageIndex = new Page({
                ajax: {
                    url: ROOTPAth + '/doctor/drugorderdetails/list',
                    type: 'POST',
                    dataType: 'json',
                    data: {
            ...
            $DrugorderdetailForm.validate({
                rules: {
                    drugname: {
                        required: true,
                        remote: { //自带远程验证存在的方法
                            url: ROOTPAth + '/doctor/drugorderdetails/hasName',
                            type: "POST",
                            dataType: "json",
                            data: {
                ...
                submitHandler: function () {
                    var savePath = ROOTPAth + '/doctor/drugorderdetails/newDrugorderdetail';
            ...
            $ModifyForm.validate({
                ...
                submitHandler: function () {
                    ...
                    var updatePath = ROOTPAth + '/doctor/drugorderdetails/modDrugorderdetail';
        ...
        deleteDrugorderdetail: function ($that) {
            var id = $that.data("id");
            var delPath = ROOTPAth + '/doctor/drugorderdetails/delDrugorderdetail/' + id;
            $.ajax({
                url: delPath,
                type: "POST",
                success: function (data) {
