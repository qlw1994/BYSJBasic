    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="iconfont">&#xe619;</i>${sessionScope.doctor.hospital.name}-${sessionScope.doctor.department.name}- ${sessionScope.doctor.name}- 日程表管理
                </div>
            </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="${ctx}/doctor/schedulings/index?pcode=1&subcode=2&hospitalid=${sessionScope.doctor.hospital.id}&hospitalname=${sessionScope.doctor.hospital.name}"
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="doctor/scheduling.js"></script>
</content>
