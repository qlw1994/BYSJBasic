define(function (require, exports, module) {
    ...
    var listTpl = juicer(
        [
            ...
            '<div class="thumbnail">',
            '{@if item.headpath == null||item.headpath==""}',
            '<img class="img-thumbnail"  style="width: 250px;height: 250px" src="${ctx}/res-build/img/avatar3_small.jpg" alt="${item.name}">',
            '{@/if}',
            '{@if item.headpath!=null&&item.headpath!=""}',
            '<img class="img-thumbnail" style="width: 250px;height: 250px" src="${item.headpath}" alt="${item.name}">',
            '{@/if}',
            '<div class="caption">',
            '<h3>${item.name}</h3>',
