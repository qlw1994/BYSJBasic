    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="iconfont">&#xe619;</i>${hospitalname}- 科室管理
                </div>
                <div class="actions">
                    <a class="btn btn-success btn-sm" href="#" data-toggle="modal" data-target="#addModal"> <i
                            class="iconfont">&#xe612;</i> <span class="hidden-480">添加科室</span>
                    </a>
                </div>
            </div>
            <div class="portlet-body" id="department-list">
                ...
                <div class="table-container">
                    <table class="table table-striped table-bordered table-hover dataTable no-footer"
                        ...
                        <thead>
                        <tr role="row">
                            <th class="sorting_desc">科室名称</th>
                            <th class="sorting">科室创建时间</th>
...
<div class="modal fade" id="addModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="vDepartmentForm">
                <div class="modal-body">
                    <div class="portlet-body form">
                        <div class="form-body">
                            <input type="hidden" class="form-control" name="hospitalid" value="${hospitalid}">
...
<div class="modal fade" id="modifyModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="vDepartmentModifyForm">
                    ...
                    <div class="portlet-body form j-disabled-item">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" AUTOCOMPLETE="off" class="form-control" name="name"
                                           disabled="disabled" placeholder="科室名称">
                                </div>
                            </div>
                        </div>
                        <!-- END FORM-->
...
<div class="modal fade bs-example-modal-sm" id="modal-box" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="${ctx}/admin/departments/index?pcode=2&subcode=1&hospitalid=${hospitalid}&hospitalname=${hospitalname}"
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js"
            data-init="admin/hospital/department.js"></script>
</content>
