...
<div class="row">
    <div class="col-md-12">
        <div class="portlet">
            ...
            <div class="portlet-body" id="drug-list">
                ...
                <div class="table-container">
                    <table class="table table-striped table-bordered table-hover dataTable no-footer"
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting">药品名</th>
                            <th class="sorting">药品规格</th>
                            <th class="sorting">药品单价</th>
...
<div class="modal fade" id="addModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="vDrugForm">
                    ...
                    <div class="portlet-body form j-disabled-item">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">药品名</label>
                                <div class="col-md-8">
                                    <input type="text" AUTOCOMPLETE="off" class="form-control" name="name" disabled="disabled" placeholder="药品名">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">药品单价</label>
                                <div class="col-md-8">
                                    <input type="text" AUTOCOMPLETE="off" class="form-control" name="price"
                                           placeholder="药品单价" disabled="disabled">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">药品规格</label>
                                <div class="col-md-8">
                                    <input type="text" AUTOCOMPLETE="off" class="form-control" name="format"
                                           placeholder="药品规格" disabled="disabled">
                                </div>
                            </div>
                            <!-- END FORM-->
                        </div>
...
<div class="modal fade bs-example-modal-sm" id="modal-box" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="${ctx}/admin/drugs/index?pcode=2&subcode=1&hospitalid=${hospitalid}&hospitalname=${hospitalname}"
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="admin/hospital/drug.js"></script>
</content>
