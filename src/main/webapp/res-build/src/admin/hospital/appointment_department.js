define(function (require, exports, module) {
    ...
    var listTpl = juicer(
        [
            ...
            '{@if index%2==0}',
            '<tr role="row" class="odd" data-patientname="${item.patientname}" data-doctorname="${item.doctorname}" data-serialnumber="${item.serialnumber}" data-regfee="${item.regfee}" data-status="${item.status}" data-date="${item.date}" data-timeflag="${item.timeflag}">',
            '{@else}',
            '<tr role="row" class="even" data-patientname="${item.patientname}" data-doctorname="${item.doctorname}" data-serialnumber="${item.serialnumber}" data-regfee="${item.regfee}" data-status="${item.status}" data-date="${item.date}" data-timeflag="${item.timeflag}">',
            '{@/if}',
