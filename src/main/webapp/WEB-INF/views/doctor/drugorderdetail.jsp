...
<div class="page-bar clearfix">
    <ul class="page-breadcrumb">
        ...
        <li><a href="#">药品订单管理</a><i class="iconfont ico-angle-right">&#xe605;</i></li>
        <li><a href="#">药品订单详情</a></li>
    </ul>
</div>
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
...
<div class="modal fade bs-example-modal-sm" id="modal-box" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="${ctx}/doctor/drugorderdetails/index?pcode=1&subcode=3&drugorderid=${drugorderid}"
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="doctor/drugorderdetail.js"></script>
</content>
