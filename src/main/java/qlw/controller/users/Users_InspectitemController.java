 ...
 */
@Controller
@RequestMapping(value = "/user/inspectitems")
public class Users_InspectitemController extends BaseController {
    @Autowired
    ...
    public ModelAndView View(long inspectionid, HttpServletRequest request) {
        ModelAndView mv = new ModelAndView("users/inspectitem");
