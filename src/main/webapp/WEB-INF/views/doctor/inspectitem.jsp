    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="iconfont">&#xe619;</i> ${sessionScope.doctor.hospitalname}-${sessionScope.doctor.departmentname}-${sessionScope.doctor.name}-${patientname}-检验单详情
                </div>
                <div class="actions">
                    <a class="btn btn-success btn-sm" href="#" data-toggle="modal" data-target="#addModal"> <i
                            class="iconfont">&#xe612;</i> <span class="hidden-480">添加详情</span>
                    </a>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">修改检验详情</h4>
            </div>
...
<div class="modal fade bs-example-modal-sm" id="modal-box" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="${ctx}/doctor/inspectitems/index?pcode=1&subcode=3&inspectionid=${inspectionid}"
