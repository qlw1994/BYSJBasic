    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="iconfont">&#xe619;</i>${sessionScope.doctor.hospitalname}-${sessionScope.doctor.departmentname}-${sessionScope.doctor.name}-${patientname}- 检查单管理
                </div>
                <div class="actions">
...
<div class="modal fade bs-example-modal-sm" id="modal-box" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="${ctx}/doctor/checkreports/index?pcode=1&subcode=3&uid=${uid}&patientid=${patientid}"
