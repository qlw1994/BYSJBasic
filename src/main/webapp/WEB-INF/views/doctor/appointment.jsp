    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="iconfont">&#xe619;</i>${sessionScope.doctor.hospital.name}-${sessionScope.doctor.department.name}-${sessionScope.doctor.name}- 预约病人查询
                </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="${ctx}/doctor/appointments/index?pcode=1&subcode=3"
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js"
            data-init="doctor/appointment.js"></script>
</content>
