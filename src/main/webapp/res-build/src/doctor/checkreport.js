define(function (require, exports, module) {
    ...
    var Utilitiy = {
        ...
        bind: function () {
            ...
            pageIndex = new Page({
                ajax: {
                    url: ROOTPAth + '/doctor/checkreports/list',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        patientid: patientid,
            ...
            $CheckreportForm.validate({
                ...
                submitHandler: function () {
                    var savePath = ROOTPAth + '/doctor/checkreports/newCheckreport';
        ...
        //     var id = $that.data("id");
        //     var delPath = ROOTPAth + '/doctor/checkreports/delCheckreport/' + id;
        //     $.ajax({
        //         url: delPath,
        //         type: "POST",
        //         success: function (data) {
