    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="${ctx}/admin/fixedschedulings/index?pcode=2&subcode=1&hospitalid=${hospitalid}&hospitalname=${hospitalname}&doctorid=${doctorid}&doctorname=${doctorname}"
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="admin/hospital/fixedscheduling.js"></script>
</content>
